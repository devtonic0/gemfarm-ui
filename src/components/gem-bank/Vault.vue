    ...
    <div class="flex">
      <template v-if="calculating">
        <div class="flex" style="flex-direction: column">
          ...
          <h1 class="noNFTs" style="text-align: center">Fetching your wallet information...</h1>
        </div>
      </template>
      <template v-else>
        <div>
...
import { BaseWalletAdapter, BaseMessageSignerWalletAdapter } from '@solana/wallet-adapter-base'
