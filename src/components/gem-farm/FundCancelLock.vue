<template>
  <div class="nes-container with-title">
    ...
    <form @submit.prevent="fundReward">
      ...
      <!--buttons-->
      <div class="flex mb-5">
        <button type="submit" class="new-button is-primary mr-5">Fund</button>
        <button
          type="button"
          class="new-button is-error mr-5"
          @click="cancelReward"
        >
          Cancel
        </button>
        <button type="button" class="new-button is-warning" @click="lockReward">
          Lock
        </button>
      </div>
    </form>
