<template>
  <div class="flex justify-center">
    <!--
    <a href="https://twitter.com/MutantMinerRats">
    ...
    <a href="https://discord.gg/mutantminerrats" style="margin-right: 20px">
...
export default defineComponent({
  ...
  setup() {
    ...
    const { cluster, setCluster, getClusterURL, getConnection } = useCluster();
        setCluster(server === "Mainnet" ? Cluster.Mainnet : server === "Mainnet" ? Cluster.Mainnet : Cluster.Mainnet);
